...
class KiwiParser(Parser):
    ...
    KEYWORDS = ('break', 'and', 'else', 'public', 'if', 'none', 'private', 'function', 'while', 'false', 'continue', 'return', 'or', 'true', 'promise', 'pass', 'namespace', 'not')
    SOFT_KEYWORDS = ('to', 'case', 'as', 'lambda', 'default', 'from', 'import', 'match')
