...
class KiwiParser(Parser):
    ...
    KEYWORDS = ('if', 'namespace', 'return', 'public', 'continue', 'break', 'while', 'none', 'promise', 'true', 'false', 'function', 'pass', 'private', 'else')
    SOFT_KEYWORDS = ('case', 'default', 'import', 'match', 'lambda', 'to', 'as', 'from')
