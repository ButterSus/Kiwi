...
class KiwiParser(Parser):
    ...
    KEYWORDS = ('return', 'if', 'true', 'namespace', 'else', 'break', 'while', 'false', 'none', 'promise', 'private', 'function', 'continue', 'public', 'pass')
    SOFT_KEYWORDS = ('import', 'lambda', 'from', 'case', 'to', 'match', 'default', 'as')
