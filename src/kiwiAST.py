...
class KiwiParser(Parser):
    ...
    KEYWORDS = ('private', 'function', 'namespace', 'false', 'true', 'promise', 'if', 'else', 'pass', 'while', 'continue', 'break', 'public', 'return', 'none')
    SOFT_KEYWORDS = ('match', 'import', 'from', 'as', 'default', 'lambda', 'case', 'to')
