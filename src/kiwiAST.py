...
class KiwiParser(Parser):
    ...
    KEYWORDS = ('true', 'namespace', 'false', 'none', 'break', 'pass', 'while', 'if', 'promise', 'else', 'private', 'function', 'return', 'public', 'continue')
    SOFT_KEYWORDS = ('default', 'from', 'as', 'match', 'to', 'lambda', 'case', 'import')
