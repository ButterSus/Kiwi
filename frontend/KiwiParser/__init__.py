...
class KiwiParser(Parser):
    ...
    KEYWORDS = ('if', 'none', 'break', 'return', 'namespace', 'while', 'promise', 'public', 'continue', 'function', 'false', 'true', 'pass', 'private', 'else')
    SOFT_KEYWORDS = ('import', 'lambda', 'default', 'match', 'case', 'as', 'to', 'from')
